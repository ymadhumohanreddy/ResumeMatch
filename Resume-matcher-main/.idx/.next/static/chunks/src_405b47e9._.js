...
"[project]/src/components/animated-intro.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function AnimatedIntro() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AnimatedIntro.useEffect": ()=>{
            // This effect runs only on the client, after initial hydration.
            const fadeTimer = setTimeout({
                "AnimatedIntro.useEffect.fadeTimer": ()=>{
                    setIsFadingOut(true);
                }
            }["AnimatedIntro.useEffect.fadeTimer"], 2500); // Start fading out after 2.5 seconds
            const hideTimer = setTimeout({
                "AnimatedIntro.useEffect.hideTimer": ()=>{
                    setIsVisible(false);
                }
            }["AnimatedIntro.useEffect.hideTimer"], 3000); // Completely hide after 3 seconds (2500ms + 500ms fade)
            return ({
                "AnimatedIntro.useEffect": ()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: `fixed inset-0 z-[100] flex flex-col items-center justify-center bg-background transition-opacity duration-500 ${isFadingOut ? 'opacity-0' : 'opacity-100'}`,
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "relative",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$rocket$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Rocket$3e$__["Rocket"], {
                    className: "h-24 w-24 animate-rocket-fly text-primary"
                }, void 0, false, {
                    fileName: "[project]/src/components/animated-intro.tsx",
                    lineNumber: 37,
                    columnNumber: 9
                }, this)
            }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                className: "mt-4 animate-fade-in-slow text-3xl font-bold tracking-tight text-foreground",
...
_s(AnimatedIntro, "ehyPTZAi3oIu+PdSBQYGQYDYdPc=");
_c = AnimatedIntro;
var _c;
__turbopack_context__.k.register(_c, "AnimatedIntro");
...
const firebaseConfig = {
    apiKey: ("TURBOPACK compile-time value", "AIzaSyCt-wtyy9VURPr0n7fbCJLENBbdWdn_ju4"),
    authDomain: ("TURBOPACK compile-time value", "resume-matcher-9bac7.firebaseapp.com"),
    projectId: ("TURBOPACK compile-time value", "resume-matcher-9bac7"),
    storageBucket: ("TURBOPACK compile-time value", "resume-matcher-9bac7.appspot.com"),
    messagingSenderId: ("TURBOPACK compile-time value", "265707558298"),
    appId: ("TURBOPACK compile-time value", "1:265707558298:web:cc9aae58d0e4f0597f9623")
};
let app = null;
let auth = null;
...
if (!isPlaceholder(firebaseConfig.apiKey) && !isPlaceholder(firebaseConfig.authDomain) && !isPlaceholder(firebaseConfig.projectId) && !isPlaceholder(firebaseConfig.storageBucket) && !isPlaceholder(firebaseConfig.messagingSenderId) && !isPlaceholder(firebaseConfig.appId)) {
    ...
    googleProvider = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$8e6e89cb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__Y__as__GoogleAuthProvider$3e$__["GoogleAuthProvider"]();
} else {
    console.warn('Firebase is not configured. Authentication will be disabled. Please add all necessary Firebase credentials to your .env file and replace placeholder values.');
}
;
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
...
function AuthProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isFirebaseEnabled"] || !__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"]) {
                setLoading(false);
                return;
            }
    ...
    const login = async ()=>{
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isFirebaseEnabled"] || !__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"] || !__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["googleProvider"]) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AuthContext.Provider, {
        value: {
            ...
            login,
            logout,
            isFirebaseEnabled: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isFirebaseEnabled"]
        },
        children: children
    }, void 0, false, {
...
//# sourceMappingURL=src_405b47e9._.js.map